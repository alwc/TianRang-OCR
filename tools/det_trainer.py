...
from metric.metrics_tools import runningScore, cal_text_score


class DetTrainer(BaseTrainer):
    def __init__(self, config, model, criterion, train_loader, validate_loader, metric, post_process=None, **kwargs):
        super(DetTrainer, self).__init__(config, model, criterion)
