...
from .img_tools import order_points_clockwise, get_datalist, load , expand_polygon, _order_points
    ...
    def _get_annotation(self, label_path: str) -> dict:
        ...
        with open(label_path, encoding='utf-8', mode='r') as f:
            for line in f.readlines():
                ...
                try:
                    box = _order_points(np.array(list(map(float, params[:8]))).reshape(-1, 2))
...
if __name__ == '__main__':
    ...
    config = anyconfig.load('../config/ccpd_aug.yaml')
