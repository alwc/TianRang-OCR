...
model_urls = {
    'gluon_resnet18_v1b': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet18_v1b-0757602b.pth',
    'gluon_resnet34_v1b': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet34_v1b-c6d82d59.pth',
    'gluon_resnet50_v1b': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet50_v1b-0ebe02e2.pth',
    'gluon_resnet101_v1b': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet101_v1b-3b017079.pth',
    'gluon_resnet152_v1b': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet152_v1b-c1edb0dd.pth',
    'gluon_resnet50_v1c': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet50_v1c-48092f55.pth',
    'gluon_resnet101_v1c': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet101_v1c-1f26822a.pth',
    'gluon_resnet152_v1c': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet152_v1c-a3bb0b98.pth',
    'gluon_resnet50_v1d': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet50_v1d-818a1b1b.pth',
    'gluon_resnet101_v1d': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet101_v1d-0f9c8644.pth',
    'gluon_resnet152_v1d': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet152_v1d-bd354e12.pth',
    'gluon_resnet50_v1e': '',
    'gluon_resnet101_v1e': '',
    'gluon_resnet152_v1e': '',
    'gluon_resnet50_v1s': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet50_v1s-1762acc0.pth',
    'gluon_resnet101_v1s': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet101_v1s-60fe0cc1.pth',
    'gluon_resnet152_v1s': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnet152_v1s-dcc41b81.pth',
    'gluon_resnext50_32x4d': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnext50_32x4d-e6a097c1.pth',
    'gluon_resnext101_32x4d': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnext101_32x4d-b253c8c4.pth',
    'gluon_resnext101_64x4d': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_resnext101_64x4d-f9a8e184.pth',
    'gluon_resnext152_32x4d': '',
    'gluon_seresnext50_32x4d': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_seresnext50_32x4d-90cf2d6e.pth',
    'gluon_seresnext101_32x4d': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_seresnext101_32x4d-cf52900d.pth',
    'gluon_seresnext101_64x4d': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_seresnext101_64x4d-f9926f93.pth',
    'gluon_seresnext152_32x4d': '',
    'gluon_senet154': 'https://github.com/rwightman/pytorch-pretrained-gluonresnet/releases/download/v0.1/gluon_senet154-70a1a3c0.pth',
}
...
class GluonResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, in_chans=3, use_se=False,
                 ...
                 norm_layer=nn.BatchNorm2d, drop_rate=0.0):
...
def gluon_resnet18_v1b(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnet18_v1b']))
    return model
...
def gluon_resnet34_v1b(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnet34_v1b']))
    return model
...
def gluon_resnet50_v1b(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnet50_v1b']))
    return model
...
def gluon_resnet101_v1b(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_state_dict_from_url(model_urls['gluon_resnet101_v1b']))
    return model
...
def gluon_resnet152_v1b(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnet152_v1b']))
    return model
...
def gluon_resnet50_v1c(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_state_dict_from_url(model_urls['gluon_resnet50_v1c']))
    return model
...
def gluon_resnet101_v1c(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_state_dict_from_url(model_urls['gluon_resnet101_v1c']))
    return model
...
def gluon_resnet152_v1c(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnet152_v1c']))
    return model
...
def gluon_resnet50_v1d(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnet50_v1d']))
    return model
...
def gluon_resnet101_v1d(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_state_dict_from_url(model_urls['gluon_resnet101_v1d']))
    return model
...
def gluon_resnet152_v1d(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnet152_v1d']))
    return model
...
def gluon_resnet50_v1e(pretrained=False, **kwargs):
    ...
    #if pretrained:
    #    model.load_state_dict(load_state_dict_from_url(model_urls['gluon_resnet50_v1e']))
    return model
...
def gluon_resnet101_v1e(pretrained=False, **kwargs):
    ...
    #if pretrained:
    #    model.load_state_dict(load_state_dict_from_url(model_urls['gluon_resnet101_v1e']))
    return model
...
def gluon_resnet152_v1e(pretrained=False, **kwargs):
    ...
    #if pretrained:
    #    model.load_state_dict(
    #        load_state_dict_from_url(model_urls['gluon_resnet152_v1e']))
    return model
...
def gluon_resnet101_v1s(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnet101_v1s']))
    return model
...
def gluon_resnet152_v1s(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnet152_v1s']))
    return model
...
def gluon_resnext50_32x4d(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnext50_32x4d']))
    return model
...
def gluon_resnext101_32x4d(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnext101_32x4d']))
    return model
...
def gluon_resnext101_64x4d(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_resnext101_64x4d']))
    return model
...
def gluon_resnext152_32x4d(pretrained=False, **kwargs):
    ...
    #if pretrained:
    #    model.load_state_dict(load_state_dict_from_url(model_urls['gluon_resnext152_32x4d']))
    return model
...
def gluon_seresnext50_32x4d(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_seresnext50_32x4d']))
    return model
...
def gluon_seresnext101_32x4d(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_seresnext101_32x4d']))
    return model
...
def gluon_seresnext101_64x4d(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_seresnext101_64x4d']))
    return model
...
def gluon_seresnext152_32x4d(pretrained=False, **kwargs):
    ...
    #if pretrained:
    #    model.load_state_dict(load_state_dict_from_url(model_urls['gluon_seresnext152_32x4d']))
    return model
...
def gluon_senet154(pretrained=False, **kwargs):
    ...
    model = GluonResNet(
        ...
        deep_stem=True, down_kernel_size=3, block_reduce_first=2, **kwargs)

    if pretrained:
        model.load_state_dict(
            load_state_dict_from_url(model_urls['gluon_senet154']))
    return model
