...
class ResNet(nn.Module):
    def __init__(self, block, layers, algorithm, num_classes=1000, dcn=None, **kwargs):
        self.dcn = dcn
        self.inplanes = 64
        ...
        self.layer2 = self._make_layer(block, 128, layers[1], stride=stride, dcn=dcn)
        self.layer3 = self._make_layer(block, 256, layers[2], stride=stride, dcn=dcn)
        self.layer4 = self._make_layer(block, 512, layers[3], stride=stride, dcn=dcn)
